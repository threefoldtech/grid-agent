...
require (
	...
	github.com/threefoldtech/grid-agent/agent v0.0.0
	github.com/threefoldtech/grid-agent/grid-cli v0.0.0-00010101000000-000000000000
...
require (
	...
	github.com/threefoldtech/tfgrid-sdk-go/grid-client v0.17.7 // indirect
...
replace github.com/threefoldtech/grid-agent/grid-cli => ../grid-cli

replace github.com/threefoldtech/grid-agent/agent => ../agent
